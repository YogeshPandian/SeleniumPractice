...
public class LoginPage {
    public static void main(String[] args) {
        ...
        String title = driver.getTitle();//getTitle method used to get the title page. Store it in a variable by using shortcut ctrl + Alt + V. <title> is a tag.getTitle also comes fromRemoteWebDriver class thats the reason we use ChromeDriver object to call the getTitle method and getTitle returns String.
